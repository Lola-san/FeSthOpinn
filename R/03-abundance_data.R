...
add_abund <- function(tibb_diet_nut) {
  tibb_diet_nut |>
    dplyr::mutate(Abund_mean = dplyr::case_when(Species == "Hydrurga leptonyx" ~ 15000 + 13200 + 7300,
                                                Species == "Lobodon carcinophaga" ~ 1736000 +
                                                  3187000 + 946400,
                                                Species == "Ommatophoca rossii" ~ 22600 + 55900,
                                                Species == "Leptonychotes weddellii" ~ 331000 + 302000),
                  Abund_min = dplyr::case_when(Species == "Hydrurga leptonyx" ~ 3500 + 3700 + 3700,
    ...
    tidyr::nest(Abund = c(Abund_mean, Abund_min, Abund_max))
